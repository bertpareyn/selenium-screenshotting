...
$query = "SELECT o.id as osTestId, o.testId, o.osId, o.browserId, s.id as subTestId, 
s.description, r.screen, r.refScreen, r.success, r.distance, r.isRef
FROM OSTests o, SubTests s, Results r
WHERE o.testId = ? AND r.osTestId = o.id AND s.osTestId = o.id AND r.subTestId = s.id";
