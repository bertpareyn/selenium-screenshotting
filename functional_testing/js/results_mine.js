...
var showBrowserReport = function(ev){
    ...
    var descriptionCArr = {};
    $(".description_column_content", "div.description_column.macosx").each(function(i){
        descriptionCArr[i] = $(".description_column_content", "div.description_column.macosx")[i];
    });
    ...
    $.TemplateRenderer("test_template", templateData, $fancyBoxContent);
